...
- The top metric row stays four-up at narrow widths: Dose, Ratio, Grind, Rating.
- Use the profile `display_name` for future user-facing labels. Do not put `email_address` on screenshot-friendly brew cards.
