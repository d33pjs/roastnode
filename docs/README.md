...
- `docs/grinder-history.md` describes latest grinder references, top-three setting counts, and explicit shared history across bean bags.
- `docs/cupping-requests.md` describes Espresso cupping-share eligibility, first-access expiry, anonymous Guest feedback, public snapshot/media privacy, audit IP handling, and export/backup lifecycle.
