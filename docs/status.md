...
- Workspace settings: household name, currency, logo, banner, optional Buy Me a Coffee support badge URL for public shared pages, and public brew-share management with URLs, linked brews, edit/remove actions, view counts, and retained recent viewer IP history.
...
- Presentation and setup polish: self-hosted Elms Sans, Roastnode brand assets, mobile-friendly back links, a global footer with GitHub/source link plus logged-in app version display, cross-links between domain records, optional demo data, and documentation for each shipped slice.
