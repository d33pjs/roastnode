...
ActiveRecord::Schema[8.1].define(version: 2026_08_29_121000) do
  ...
  create_table "cupping_requests", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "expiration_job_enqueued_at"
    t.datetime "expiration_job_enqueueing_at"
    ...
    t.index ["feedback_expires_at"], name: "index_cupping_requests_on_open_expiration", where: "((opened_at IS NOT NULL) AND (closed_at IS NULL))"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.string "default_brew_focus_field", default: "bean_weight_grams", null: false
  ...
  create_table "workspaces", force: :cascade do |t|
    t.string "buy_me_a_coffee_display_mode", default: "link", null: false
    t.string "buy_me_a_coffee_slug"
    t.string "buy_me_a_coffee_text"
    t.string "buy_me_a_coffee_url"
    t.datetime "created_at", null: false
