...
- Beans support rich metadata, edit/close/reopen/duplicate workflows, and additive package photos. Duplicate bags should reset remaining grams to bag size, use the current date as opened date, clear archived state, and reuse existing photo blobs.
